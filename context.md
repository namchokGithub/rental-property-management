...
| Responsive                    | Done   | Verified at 375/768/1024px via headless Chrome screenshots across all 6 pages; sidebar becomes a Sheet drawer under `md`; Billing, Invoices, Rooms, Tenants tables and the Other Charge Master list become cards under `md`; header title truncates instead of wrapping below `md`                                                                             |
