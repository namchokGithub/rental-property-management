...
type Status = RoomStatus | TenantStatus | BillingStatus | InvoiceStatus | AssignmentStatus;
...
const STYLES: Record<Status, string> = {
  ...
  superseded: "bg-slate-100 text-slate-600 hover:bg-slate-100 dark:bg-slate-500/15 dark:text-slate-300 dark:hover:bg-slate-500/15",
