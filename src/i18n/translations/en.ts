...
const en: Translations = {
  ...
  billing: {
    ...
    issueConfirmDescription: "This will issue an invoice for room {{roomNumber}} and assign it an invoice number.",
    bulkIssueConfirmTitle: "Issue selected invoices?",
    bulkIssueConfirmDescription: "This will issue {{count}} selected billing record(s) and assign invoice numbers.",
    markPaidConfirmTitle: "Mark this invoice as paid?",
    markPaidConfirmDescription: "This will record invoice {{invoiceNumber}} as paid.",
  ...
  invoice: {
    ...
    bulkExportSelected: "Export Excel ({{count}})",
    exportDateLabel: "Export Date :",
    exportByLabel: "Export By :",
    otherChargesColumn: "Other Charges",
    invoiceNumber: "Invoice #",
    room: "Room",
    tenant: "Tenant",
    billingMonth: "Billing Month",
    ...
    markAsPaid: "Mark as Paid",
    deleteInvoice: "Delete Invoice Version",
    deleteSelected: "Delete Selected ({{count}})",
    deleteConfirmTitle: "Delete this invoice version?",
    deleteConfirmDescription: "This only removes {{count}} selected superseded invoice version(s). The billing record and its current invoice will remain unchanged.",
    deletedToast: "Invoice version deleted",
