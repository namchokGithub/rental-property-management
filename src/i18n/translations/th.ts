...
const th: Translations = {
  ...
  room: {
    ...
    descriptionLabel: "ที่อยู่ห้องพัก",
  ...
  billing: {
    ...
    issueConfirmTitle: "ต้องการออกใบแจ้งหนี้นี้หรือไม่?",
    issueConfirmDescription: "ระบบจะออกใบแจ้งหนี้สำหรับห้อง {{roomNumber}} และกำหนดเลขที่ใบแจ้งหนี้",
    bulkIssueConfirmTitle: "ต้องการออกใบแจ้งหนี้ที่เลือกหรือไม่?",
    bulkIssueConfirmDescription: "ระบบจะออกใบแจ้งหนี้ให้รายการบิลที่เลือก {{count}} รายการ และกำหนดเลขที่ใบแจ้งหนี้",
    markPaidConfirmTitle: "ต้องการบันทึกว่าใบแจ้งหนี้นี้ชำระแล้วหรือไม่?",
    markPaidConfirmDescription: "ระบบจะบันทึกใบแจ้งหนี้ {{invoiceNumber}} ว่าชำระแล้ว",
  ...
  invoice: {
    ...
    bulkExportSelected: "ส่งออก Excel ({{count}})",
    exportDateLabel: "วันที่ส่งออก :",
    exportByLabel: "ผู้ส่งออก :",
    otherChargesColumn: "ค่าอื่น ๆ",
    invoiceNumber: "เลขที่ใบแจ้งหนี้",
    room: "ห้อง",
    tenant: "ผู้เช่า",
    billingMonth: "เดือนที่เรียกเก็บ",
    ...
    markAsPaid: "บันทึกว่าชำระแล้ว",
    deleteInvoice: "ลบใบแจ้งหนี้ฉบับนี้",
    deleteSelected: "ลบฉบับเก่าที่เลือก ({{count}})",
    deleteConfirmTitle: "ต้องการลบใบแจ้งหนี้ฉบับนี้หรือไม่?",
    deleteConfirmDescription: "การดำเนินการนี้จะลบเฉพาะใบแจ้งหนี้ฉบับเก่าที่ถูกแทนที่ที่เลือกไว้ {{count}} ฉบับเท่านั้น รายการบิลและใบแจ้งหนี้ฉบับปัจจุบันจะไม่เปลี่ยนแปลง",
    deletedToast: "ลบใบแจ้งหนี้ฉบับเก่าเรียบร้อยแล้ว",
    ...
    propertyAddressLabel: "ที่อยู่-สถานที่",
    ...
    currencyUnit: "บาท",
    remark: "หมายเหตุ",
    paymentInfoTitle: "ข้อมูลการชำระเงิน (เมื่อมีการชำระแล้ว)",
    paidDateLabel: "วันที่ชำระเงิน",
    paymentMethodLabel: "วิธีการชำระเงิน",
    paidAmountLabel: "จำนวนเงินที่ชำระ",
    transactionIdLabel: "เลขที่รายการ / Transaction ID",
  },
  settings: {
    title: "ตั้งค่า",
